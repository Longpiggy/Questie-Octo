...
local function CreateTrackerTab()
  return {
    ...
    args={
      ...
      trackerVisibleRows={type="range",order=22,name="Visible Rows",desc="Maximum number of complete tracker rows shown at once. The tracker height is calculated automatically so text is never partially cropped. ( Default: 30 )",width="double",min=6,max=60,step=1,get=GetValue,set=SetValue},
      trackerBackgroundOpacity={type="range",order=23,name="Tracker Background Opacity",desc="Opacity of the tracker background. 0 is fully transparent, matching old Questie's default tracker presentation. ( Default: 0 )",width="double",min=0,max=1,step=0.05,get=GetValue,set=SetValue},
